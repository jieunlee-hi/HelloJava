...
public class Arrays {
	public static void main(String[] args) {
		...
		// System.out.printf(fmt, kor[0]);
		//
		// System.out.println(names[1]);
		// System.out.printf(fmt, kor[1]);
		//
		// System.out.println(names[2]);
		// System.out.printf(fmt, kor[2]);
		//
		...
		// 1 ~ 45 정수를 출력하는 난수 코드 작성

		System.out.println("정수 6개 출력");
		int i = 0;
		for (int j = 0; j < 3; j++) {
			for (i = 0; i < 6; ++i) {
